...
// function formatCategoryMoney(number) {
...
// async function handleCategoryBid() {
...
//         currentBidTarget.index !== undefined
//     ) {
...
//     if (window.location.hash === "#trending-auctions") {
//         setTimeout(() => {
...
//     document.querySelectorAll('a[href="#trending-auctions"], a[href="/#trending-auctions"]')
//         .forEach(link => {
//             link.addEventListener("click", function (event) {
//                 event.preventDefault();

//                 history.pushState(null, "", "/#trending-auctions");
...
document.querySelectorAll(
    'a[href="#trending-auctions"], a[href="/#trending-auctions"]'
).forEach(link => {
    link.addEventListener("click", event => {
        event.preventDefault();
...
document.querySelectorAll(
    'a[href="#categories"], a[href="/#categories"]'
).forEach(link => {
    link.addEventListener("click", event => {
        event.preventDefault();
...
const updateActiveNav = () => {
    ...
    if (
        trendingSection &&
        scrollPosition >= trendingSection.offsetTop
    ) {
        document.querySelector(
            '.custom-navbar a[href="#trending-auctions"]'
        )?.classList.add("active");
...
if (window.location.hash === "#trending-auctions" && trendingSection) {
    setTimeout(() => {
        trendingSection.scrollIntoView({
            behavior: "smooth",
            block: "start"
...
if (window.location.hash === "#categories" && categoriesSection) {
    setTimeout(() => {
        categoriesSection.scrollIntoView({
            behavior: "smooth",
            block: "start"
